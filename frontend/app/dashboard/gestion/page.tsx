...
export default function GestionPage() {
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-6 pb-20">
            ...
            {/* 🟢 4. TAMBIÉN OCULTAMOS EL PANEL DE SUBIDA POR SI ACASO */}
            {!esAuditor && showUpload && (
                <form onSubmit={handleUpload} className="bg-white p-6 rounded-xl border shadow-sm animate-in fade-in slide-in-from-top-4 flex flex-col md:flex-row items-center gap-4">
                    <div className="flex-1 w-full">
                        <label className="block text-sm font-bold text-gray-700 mb-2">Archivo Excel (Plan de Capacitaciones)</label>
                        <input
                            type="file"
                            accept=".xlsx, .xls"

...
export default function AppPreview() {
    return (
        <div className="relative z-20 -mt-24 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            ...
            <div className="relative rounded-2xl bg-white/40 backdrop-blur-xl border border-white/60 p-2 shadow-2xl shadow-blue-900/10 lg:rounded-3xl lg:p-3 ring-1 ring-black/5 overflow-hidden group">

                {/* barra de título */}
                <div className="absolute top-0 left-0 right-0 h-8 md:h-10 bg-white/80 backdrop-blur-md rounded-t-2xl z-10 flex items-center px-4 border-b border-gray-100/50">
                    ...
                    <div className="mx-auto text-[10px] md:text-xs font-medium text-gray-400/80 uppercase tracking-widest hidden sm:block">
                        Formapp Dashboard
                    </div>
                </div>

                {/* captura de pantalla */}
                <div className="relative aspect-[16/10] w-full rounded-xl overflow-hidden bg-gray-50 mt-8 md:mt-10 border border-gray-200/50">
                    <Image
